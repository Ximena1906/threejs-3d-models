...
function init() {
    ...
    // ⌨️ Escuchar teclas del 1 al 5 para cambiar animación
    window.addEventListener('keydown', (event) => {
        const key = event.key;
        switch (key) {
            case '1':
                params.animation = 'Dancing';
                playAnimation('Dancing');
                break;
            case '2':
                params.animation = 'Punching';
                playAnimation('Punching');
                break;
            case '3':
                params.animation = 'Punching Bag';
                playAnimation('Punching Bag');
                break;
            case '4':
                params.animation = 'Dying';
                playAnimation('Dying');
                break;
            case '5':
                params.animation = 'Jumping';
